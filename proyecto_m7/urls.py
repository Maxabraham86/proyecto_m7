...
from inmueble.views import nuevo_inmueble, crear_inmueble, editar_inmueble, eliminar_inmueble, detalle_inmueble
...
urlpatterns = [
    ...
    path('inmueble/detalle/<id>', detalle_inmueble, name='detalle_inmueble'),
